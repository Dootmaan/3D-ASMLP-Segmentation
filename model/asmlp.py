...
from .shift_cuda import torch_shift, Shift
import numpy as np
...
class Med_ASMLP(nn.Module):
    def __init__(self, img_size=[128,192,192], patch_size=4, in_chans=1, num_classes=1,
        ...
        self.head = nn.Sequential(
            ...
            nn.Sigmoid()) if num_classes > 0 else nn.Identity()
